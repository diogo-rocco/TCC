...
from monolith_modular_version.core.validators.date_validator import DateValidator
from monolith_modular_version.core.validators.weather_validator import WeatherValidator
